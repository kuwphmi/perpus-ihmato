  ...
  return (
    <div className="min-h-screen bg-gray-100 pb-28">
      ...
      <div className="relative h-56 bg-blue-500">
        <img src="https://images.unsplash.com/photo-1500530855697-b586d89ba3ee" className="w-full h-full object-cover opacity-40" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 -mt-16 relative z-10">
        <div className="flex flex-col md:flex-row gap-6 items-center md:items-end">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-xl font-bold text-gray-800">{user.name?.toUpperCase()}</h2>
          ...
          <div className="bg-white rounded-xl shadow p-6">
            ...
            <div className="space-y-4 text-sm">
              {[
                ...
                { label: "Tanggal Lahir", key: "birth", type: "date" },
              ].map(({ label, key, type, readOnly }) => (
                <div key={key}>
                  <p className="text-gray-500 mb-1">{label}</p>
                  {isEdit && !readOnly ? (
                    <input type={type} value={user[key] || ""} onChange={(e) => setUser({ ...user, [key]: e.target.value })} className="border rounded-lg px-3 py-2 w-full focus:outline-blue-500" />
                  ) : (
              ...
              <div>
                ...
                {isEdit ? (
                  <select value={user.gender || ""} onChange={(e) => setUser({ ...user, gender: e.target.value })} className="border rounded-lg px-3 py-2 w-full focus:outline-blue-500">
