              ...
              >
                <div className="flex items-center gap-5">
                  <img
                    src={
                      order.cover
                        ? `https://covers.openlibrary.org/b/id/${order.cover}-L.jpg`
                        : "/default-cover.png"
                    }
                    alt={order.title}
                ...
                <div className="flex flex-col items-start md:items-end gap-3">
                  ...
                  {order.order_status === "processing" && (
                    <>
                      ...
                      <button
                        onClick={() => setSelectedOrder(order)}
                        className="border border-indigo-500 text-indigo-600 px-4 py-2 rounded-xl text-sm hover:bg-indigo-50 transition"
                      >
                        View Receipt
                      </button>
                    </>
                  ...
                  {(order.order_status === "shipping" ||
                    order.order_status === "ready_pickup") && (
                      <>
                        <span
                          className={`px-4 py-2 rounded-full text-sm font-medium ${order.order_status === "ready_pickup"
                        ...
                        <button
                          onClick={() => setSelectedOrder(order)}
                          className="border border-blue-500 text-blue-600 px-4 py-2 rounded-xl text-sm hover:bg-blue-50 transition"
                        >
                          View Receipt
                        </button>
                      </>
                  ...
                  {order.order_status === "completed" && (
                    <>
                      ...
                      <button
                        onClick={() => setSelectedOrder(order)}
                        className="border border-green-500 text-green-600 px-4 py-2 rounded-xl text-sm hover:bg-green-50 transition"
                      >
                        View Receipt
                      </button>
                    </>
...
">
                  ...
                  {/* DETAIL */}
                  <div className="mt-6 bg-gray-50 rounded-2xl p-4 space-y-4 text-sm">
